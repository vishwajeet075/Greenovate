document.addEventListener("DOMContentLoaded", function() {
    ...
    const metrics = {
        ...
        planet: {
            ...
            metric2: { value: "80%", desc: "Resource Efficiency", detail: "Optimize the use of natural resources by repurposing captured carbon.", arrow: "../assets/images/arrow.png" },
            metric3: { value: "90%", desc: "Sustainable impact", detail: "Contributes to long-term environmental sustainability and combats climate change.", arrow: "../assets/images/arrow.png" }
        }
    };
